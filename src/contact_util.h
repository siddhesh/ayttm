...
eb_account *find_account_by_handle(const char *handle,
	const eb_local_account *ela);
eb_account *find_account_by_handle_and_service(const char *handle,
	int service_id);
...
struct contact *add_contact(const char *contact_name, const char *group_name,
	int default_service);
struct contact *add_contact_with_group(const char *contact_name,
	grouplist *group, int default_service);
struct contact *add_dummy_contact(const char *contact_name, eb_account *ea,
