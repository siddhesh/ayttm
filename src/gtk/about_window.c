...
static GtkTable	*sMakeDeveloperTable( int inNumDevelopers, const tDeveloperInfo *inDevInfo )
{
...
void	ay_ui_about_window_create( const tAboutInfo *inAboutInfo )
{
	...
	table = sMakeDeveloperTable( inAboutInfo->m_num_ay_developers, inAboutInfo->m_ay_developers );
	...
	table = sMakeDeveloperTable( inAboutInfo->m_num_ay_kudos, inAboutInfo->m_ay_kudos );
	gtk_box_pack_start( vbox2, GTK_WIDGET(table), TRUE, TRUE, 5 );
	...
	table = sMakeDeveloperTable( inAboutInfo->m_num_eb_developers, inAboutInfo->m_eb_developers );
	gtk_box_pack_start( vbox2, GTK_WIDGET(table), TRUE, TRUE, 5 );

	gtk_scrolled_window_add_with_viewport( GTK_SCROLLED_WINDOW(scroll), GTK_WIDGET(vbox2) );
